;*******************************************************
;* CMPEN 472, HW11 converting analog 
;*            signal to digital data, MC9S12C128 Program
;*
;* Date: 11/27/2023     Aly Ghallab 
;*
;* Term ATD = ADC = Analog-to-Digital Converter
;* 
;*   Used ADC in conjuction with Timer Interrupt (OC6)
;*   
;*
;* For SIMULATOR:
;*                  commands    
;*                    'Here are all the possible Commands (NOTE: Commands are CASE SENSITIVE) No Unnecessary Spaces',
;*                    'Nothing is Displayed on 7 segment Display until one of the Display Commands (h,m,s) is entered or user is in TypeWriter Mode', 
;*                    't: Command Format: t <hh>:<mm>:<ss><Enter-key(CR)>',
;*                    'h: Display hour on 7 segment display in hex', 
;*                    'm: Display minutes on 7 segment display in hex', 
;*                    's: Display seconds on 7 segment display in hex', 
;*                    'q: Quit menu program, run "Type writer" program.', 
;*                    'gw: Generate Sawtooth Wave for 2048 points', 
;*                    'gw2:Generate 100Hz Sawtooth Wave for 2048 points',
;*                    'gt: Generate triangle Wave for 2048 points', 
;*                    'gq: Generate Square Wave for 2048 points', 
;*                    'gq2:Generate 100Hz Square Wave for 2048 points', 
;*                    'adc: Run Analog Digital Converter for 2048 points',
;*
;*******************************************************
; export symbols
...
analog_digital_converter
            ...
            JSR     nextline
            ldx     #msg_adc          ; print 'Analog Signal Acquisition ... '
            jsr     printmsg
            jsr     nextline
...
msg_adc     DC.B   'Analog Signal Acquisition...', $00 
...
commands    
            ...
            DC.B        'h: Display hour on 7 segment display in hex', CR, LF
            DC.B        'm: Display minutes on 7 segment display in hex', CR, LF
            DC.B        's: Display seconds on 7 segment display in hex', CR, LF
            DC.B        'q: Quit menu program, run "Type writer" program.', CR, LF
            DC.B        'gw: Generate Sawtooth Wave for 2048 points', CR, LF
            DC.B        'gw2:Generate 100Hz Sawtooth Wave for 2048 points', CR, LF
            DC.B        'gt: Generate triangle Wave for 2048 points', CR, LF
            DC.B        'gq: Generate Square Wave for 2048 points', CR, LF
            DC.B        'gq2:Generate 100Hz Square Wave for 2048 points', CR, LF
            DC.B        'adc: Run Analog Digital Converter for 2048 points', $00
